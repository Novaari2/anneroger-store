            ...
            <div className="mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-24 lg:max-w-7xl lg:px-8">
                <div className="lg:grid lg:grid-cols-2 lg:items-start lg:gap-x-8">
                    <div className="aspect-h-1 aspect-w-1 w-full">
                        <img src={product.imageSrc} alt={product.imageAlt} className="h-full w-full object-cover object-center sm:rounded-lg" />
                    </div>
                    <div className="mt-10 px-4 sm:mt-16 sm:px-0 lg:mt-0">
                        ...
                        <div className="mt-6">
                            ...
                            <div className="text-base leading-relaxed text-gray-700" dangerouslySetInnerHTML={{ __html: product.description}}>
                            </div>

                            <div className="mt-6">
                                <div className="space-y-3 rounded-lg bg-white p-4 shadow">
                                    <div>
                                        <RadioGroup value={selectedAttribute} onChange={setSelectedAttribute} className='mt-2'>
                                            <RadioGroup.Label className='sr-only'>Choose variation 1</RadioGroup.Label>
                                            <div className="flex flex-wrap gap-3">
                                                {Object.keys(product.variations).map((key, index) => (
                                                    <RadioGroup.Option key={key} value={key} className={({ active, checked}) => {
                                                        clsx(
                                                            ...
                                                            'inline-flex items-center justify-center rounded-md border px-3 py-2 text-fs font-medium uppercase',
