...
export default function OrderSummary({ shipping = '-' }) {
    ...
    let totalAfterCost = parseInt(order_summary.total?.replace(/\D/g, '')) + parseInt(shipping?.replace(/\D/g, '') || 0);
    return (
            ...
            <div className='mt-4 rounded-lg border border-slate-200 bg-white shadow-sm'>
                ...
                <dl className='space-y-6 border-t border-slate-200 px-4 py-6 sm:px-6'>
                    ...
                    <div className='flex items-center justify-between border-t border-slate-200 pt-6'>
                        ...
                        <dd className='text-base font-medium text-slate-900'>Rp {number_format(totalAfterCost, 0, ',', '.')}</dd>
                    </div>
                </dl>
