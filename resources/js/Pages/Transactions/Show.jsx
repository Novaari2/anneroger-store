...
export default function Show({ transaction }) {
    ...
    Echo.private(`transactions.${transaction.customer_id}`).listen('InvoicePaid', (event) => {
        if (event.transaction.transaction_status === 'settlement' && transaction.order_id) {
            setPaid(true);
        }
    });
    return (
            ...
            <div>
                ...
                <div className='mt-2 pb-5 text-sm sm:flex sm:justify-between'>
                    ...
                    <div className='mt-4 sm:mt-0'>
                        <a href={route('invoices.download', [page.props.transaction])} className='font-medium text-blue-600 hover:text-blue-500'>
                            Download invoice
