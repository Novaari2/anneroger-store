...
class CheckoutController extends Controller
{
    public function index(Request $request)
    {
        ...
        $shippingAddress = $request->user()->defaultShippingAddress?->load('province:id,name','city:id,name,postal_code');
    ...
    public function store(TransactionRequest $request, TransactionInterface $transactionService)
    {
                ...
                'shipping_information' => [
                    ...
                    ...[
                        'address' => [
                            ...
                            // 'subdistrict' => $request->user()->defaultShippingAddress->subdistrict,
                        ],
                    ],
                ],
        ...
        // redirect if transaction is created
